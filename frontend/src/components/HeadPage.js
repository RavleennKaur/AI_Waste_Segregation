...
const products = [
  {
    id: 1,
    name: 'Plastic',
    href: 'https://en.wikipedia.org/wiki/Plastic',
    imageSrc: 'https://assets.theoceancleanup.com/scaled/1200x675/app/uploads/2023/04/Large-220604_Guatemala_Helicopter_Val_S5_pic_324-scaled.jpg',
    imageAlt: 'rust',
  },
  {
    id: 2,
    ...
    imageSrc: 'https://plus.unsplash.com/premium_photo-1675695700239-44153e6bf430?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8cGFwZXIlMjB0ZXh0dXJlfGVufDB8fDB8fHww',
    imageAlt: 'Olive.',
  },
  {
    id: 3,
    ...
    imageSrc: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnbPEIXJIRFRLlNjnV8PDnLCjcNTfD11JKQA&usqp=CAU',
    imageAlt: '',
  },
  {
    id: 4,
    name: 'Trash',
    href: 'https://en.wikipedia.org/wiki/Trash',
    imageSrc: 'https://publicinterestnetwork.org/wp-content/uploads/2018/02/MN-dump.jpg',
    imageAlt: 'Hand holding black machined steel mechanical pencil with brass tip and top.',
  },
  {
      id: 5,
      name: 'Cardboard',
      href: 'https://en.wikipedia.org/wiki/Cardboard#:~:text=Cardboard%20is%20a%20generic%20term,of%20multiple%20plies%20of%20material.',
      imageSrc: 'https://i.ebayimg.com/images/g/OUIAAOSwz29kigz2/s-l1200.webp',
      imageAlt: 'Hand holding black machined steel mechanical pencil with brass tip and top.',
  },
  {
      id: 6,
      ...
      imageSrc: 'https://m.foolcdn.com/media/dubs/original_images/silver_metal_bars_stacked_atop_one_another.jpg',
      imageAlt: 'Hand holding black machined steel mechanical pencil with brass tip and top.',
  }
]
    ...
    <div className="relative bg-white overflow-hidden">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-amber-400 sm:text-5xl md:text-6xl">
                <span className="block xl: text-600 xl:inline" style={{ marginLeft: '100px' }}>Waste </span>
                <br></br>
              </h1>

              <h1 className="text-4xl tracking-tight font-extrabold text-400 sm:text-5xl md:text-6xl">
                <span className="block xl: text-600 xl:inline" style={{ marginLeft: '220px' }}> Bot</span>
                <br></br>
              </h1>

              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
              At Waste Bot, we're pioneering the future of waste segregation with our cutting-edge AI system, WasteSort. Our platform employs advanced machine learning algorithms to accurately categorize and sort different types of waste, promoting efficient recycling and environmental sustainability. Just as CropCheck revolutionizes crop disease detection, WasteSort revolutionizes waste management, contributing to a cleaner and greener world. </p>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img
          ...
          src="https://scx2.b-cdn.net/gfx/news/hires/2009/dustbot.jpg"
          alt=""
        />
      </div>
    </div>
...
<section className="mb-32 text-gray-800 text-center">
  ...
  <div id="carouselExampleCaptions" className="carousel slide relative carousel-dark" data-bs-ride="carousel">
    <div className="carousel-inner relative w-full overflow-hidden">
      ...
      <img class="rounded-full shadow-lg mb-3 mx-auto" src={akshaj} />
        <div className="flex flex-wrap justify-center">
          <div className="grow-0 shrink-0 basis-auto w-full lg:w-8/12 px-3">
            <h5 className="text-lg font-bold mb-3">Akshaj Rakhecha</h5>
            <p className="font-medium text-gray-700 mb-4">CEO of symptoLens AI</p>
    ...
    <div>
        ...
        <span className="bg-clip-text xl:px-16 font-semibold font-serif text-[40px] text-600 text-amber-400 animate-pulse">
          Garbage types you can recycle
        </span>
            </div>

            <div className='container text-center pb-10'>
        <span className="bg-clip-text xl:px-16 font-light text-[20px] text-600">
        Garbage management is a significant concern as it can cause significant damage to our planet, leading to increase in global warming and economic losses. 
        </span>
            </div>

            <div className="bg-white">
                <div className="max-w-2xl mx-auto py-8 px-8 sm:py-4 sm:px-6 lg:max-w-7xl lg:px-4">
                <div className="grid grid-cols-1 gap-y-16 sm:grid-cols-2 gap-x-12 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-14">
...
<section className="bg-white border-spacing-2 border-s-violet-50">
  ...
  <div className="max-w-4xl mx-auto flex justify-between items-center">
    <div className="w-1/2">
      ...
      <p className="text-lg mb-2"> 5 ST. Joseph Street</p>
      <p className="text-lg mb-2">+91 9289039721</p>
      <p className="text-lg mb-2">+1 647-829-1569</p>
    </div>
  ...
  <div className="max-w-4xl mx-auto border-t border-white pt-4 mt-8">
    <p className="text-center text-sm">&copy; 2023 Team-Copilots. All Rights reserved.</p>
  </div>
</div>
    </>
  )

...
const navigation = [
    { name: 'Home', to: '/' },
    { name: 'What We Do', to: '/Cropchecker' },
    { name: 'About WasteBotAI', to: '/weather' },
];
...
export default function Navbar() {
    ...
    const handleLogout = () => {
        // Perform logout logic, clear localStorage or perform API call if needed
                                    ...
                                    <div className="flex">
                                        {isAuthenticated ? (
                                            <>
                                                ...
                                                {/* Add other authenticated user options here */}
                                            </>
                                        ) : (
                                            <>
                                                <Link
